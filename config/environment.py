...
class Config:
    ...
    def load_environment(self) -> None:
        ...
        self.redis_url = os.getenv('REDIS_URL', f'redis://{self.redis_host}:{self.redis_port}/{self.redis_db}')
        ...
        self.rabbitmq_url = os.getenv('RABBITMQ_URL', f'amqp://{self.rabbitmq_user}:{self.rabbitmq_password}@{self.rabbitmq_host}:{self.rabbitmq_port}{self.rabbitmq_vhost}')
    ...
    def get_connection_info(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'rabbitmq': {
                ...
                'url': self.rabbitmq_url.replace(self.rabbitmq_password, '***') if self.rabbitmq_password else self.rabbitmq_url
            },
