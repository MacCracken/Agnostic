# agnostic — Claude Code Instructions
...
_TODO: one-or-two-sentence mission statement. What does agnostic OWN in the stack? Durable — doesn't change per release._
